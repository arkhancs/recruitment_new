...
if ($_FILES["noc"]["name"] != '' || $_FILES["caste_certi"]["name"] != '' || $_FILES["expr_certi"]["name"] != '' || $_FILES["other_file"]["name"] != '' || $_FILES["master_degree_certi"]["name"] != '') {
    ...
    $msg = "<div class='bg-success' style='padding: 10px;'>Documents Uploaded Successfully.</div>";
    session_start();
    $_SESSION['msg'] = $msg;
