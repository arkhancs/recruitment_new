...
$sql = "SELECT a.id,CONCAT(surname,' ',a.name,' ',fathername, '\n','(',a.category,') ',a.caste_certino,', ',a.caste_certi_issue_year) as name, a.category AS category,"
    ...
    . "CONCAT(d.transaction_ref_no, ', ', DATE_FORMAT(STR_TO_DATE(d.dd_date, '%m/%d/%Y'), '%d/%m/%Y'), ', ', d.dd_amount) as payment_info, a.regdate, d.hard_copy_received, d.inward_no, d.inward_date FROM prsnl a "
