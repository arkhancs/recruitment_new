    ...
    <div class="login-form">
        <form name="form1" method="post">
            <div class="row titleText">
                ...
                $sql_p = "SELECT job_type, open_date_admin, closed_date_admin, advertisement_title, advertisement_url, status FROM req_experience WHERE closed_date_admin >= '$current_date' AND status = 'OPEN'  
                ...
                if (mysqli_num_rows($result_p) > 0) {
                    foreach ($result_p as $r) {
                        ...
                        if ($open_date <= $current_date1 && $status == 'OPEN' && !empty($advertisement_url)) {
                            ...
                            // if ($open_date <= $current_date1 && $status == 'OPEN') {
