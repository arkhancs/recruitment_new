                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="typing_div1" style="display:<?php
                                                                if (isset($post) && ($post == "CCTAdmin-2-2023" || $post == "PSAdmin-2-2023")) {
                                                                    echo 'block';
                                                                    $required1 = "required";
                                                                } else {
                                                                    echo 'none';
                    ...
                    <tbody>
                        ...
                        <tr id="dd_div">
                            ...
                            <td colspan="2">
                                ...
                                <input type="text" name="transaction_pref" id="transaction_pref" maxlength="3" placeholder="DUC/DUK/DUL" required class="form-control" value="<?php
...
<div id="dialog" style="display: none;" align="center">
    ...
    <strong style="color:red">The hardcopy of the online Application along with legible/readable copies of all self-attested testimonials, certificates and all supporting documents should reach to "Recruitment Cell, INFLIBNET Centre, OPP.NIFT, Infocity, Gandhinagar, Gujarat-382007" on or before 18/02/2024 upto 06.00 PM, failing which the application will be rejected. <br />Application not made online and print out of online Application along with all testimonials not received will be summarily rejected.</strong>
    </br></br>
...
<script type="text/javascript">
    ...
    function validate1() {
        ...
        if (document.frmregister.mobile.value.length != 10) {
            ...
            //                return true;
            //            }
        } else if (document.frmregister.post.value == "CCTAdmin-2-2023") {
