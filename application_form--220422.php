...
<body>
    ...
    <div class="container" style="padding-top:5px;padding-bottom: 20px; border-radius: 5px; ">
        ...
        <ul class="nav nav-pills">
            ...
            <?php if ($_SESSION['is_login'] == 'true') { ?><li class="pull-right"><a href="logout.php" style="padding:0 !important"><i class="fas fa-power-off" style="font-size:25px"></i></a></li><?php } ?>
        </ul>
        <div class="tab-content">
            <div id="personal" class="tab-pane fade in active" style="border: 1px gray solid; border-radius: 5px;">
                <form name="frmregister" id="frmregister" action="login.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-4">
                                <select name="post" id="post" class="form-control" required <?php
                                                                                            if ($_SESSION['is_login'] == 'true') {
                                                                                                echo 'disabled';
                                                                                            }
                            ...
                            <div id="hidden_div" style="display: <?php
                                ...
                                <div class="col-md-2">
                                    <label for="issue" style="text-align:left"><b>Year of Issue:<font style="color:red">*</font></b></label>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div id="service_div" style="display:<?php
                                                                    if (isset($post) && ($post == 'PSAdmin-1-2022' || $post == 'AAdmin-1-2022')) {
                                                                        echo "block";
                                                                    } else {
                                                                        echo "none";
                                                                    }
                                ...
                                <div class="col-md-4">
                                    <select name="type_of_service" id="type_of_service" class="form-control" <?php echo isset($post) ? 'disabled' : ''; ?>>
                            ...
                            <div id="job_type_div" style="display: <?php
                                ...
                                <div class="col-md-4">
                                    <select name="type_of_job" id="type_of_job" class="form-control" <?php echo isset($post) ? 'disabled' : ''; ?>>
                            ...
                            <div class="col-md-4">
                                <input name="mobile" class="form-control" required maxlength="10" type="number" placeholder="Enter only 10 digit number" value="<?php echo (isset($mobile)) ? "$mobile" : ""; ?>" />
                            </div>
                            <div style="clear:both;"></div><br />
                            <div class="col-md-2">
                            ...
                            <div id="typing_div" style="display:<?php
                                                                if (isset($post) && ($post == "PSAdmin-1-2022")) {
                                                                    echo 'block';
                                                                } else {
                                                                    echo 'none';
                                                                }
                                                                ?>">
                                <div class="col-md-2">
                                    <label for="steno" style="text-align:left"><b>StenoGraphy Speed(w.p.m.):</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="stenoGraphy_speed" id="stenoGraphy_speed" value="<?php echo (isset($stenoGraphy_speed)) ? "$stenoGraphy_speed" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="col-md-2">
                                    <label for="steno_certi_no" style="text-align:left"><b>StenoGraphy Certificate Number:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="stenography_certi_no" id="stenography_certi_no" value="<?php echo (isset($stenography_certi_no)) ? "$stenography_certi_no" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="clearfix"></div><br />
                                <div class="col-md-2">
                                    <label for="steno_certi_date" style="text-align:left"><b>StenoGraphy Certificate Date:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="stenography_certi_date" id="stenography_certi_date" value="<?php echo (isset($stenography_certi_date)) ? "$stenography_certi_date" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="col-md-2">
                                    <label for="steno_certi" style="text-align:left"><b>StenoGraphy Certificate:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <?php
                                    ...
                                    ?>
                                    <input type="file" name="stenography_certi" id="stenography_certi"></input>
                                ...
                                <div class="clearfix"></div><br />
                                <div class="col-md-2">
                                    <label for="sspeed" style="text-align:left"><b>Typing Speed(w.p.m.):</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="typing_speed" id="typing_speed" value="<?php echo (isset($typing_speed)) ? "$typing_speed" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="col-md-2">
                                    <label for="sspeed" style="text-align:left"><b>Typing Speed Certificate Number:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="typing_certi_no" id="typing_certi_no" value="<?php echo (isset($typing_certi_no)) ? "$typing_certi_no" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="clearfix"></div><br />
                                <div class="col-md-2">
                                    <label for="tcdate" style="text-align:left"><b>Typing Speed Certificate Date:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="typing_certi_date" id="typing_certi_date" value="<?php echo (isset($typing_certi_date)) ? "$typing_certi_date" : ""; ?>" class="form-control"></input>
                                </div>
                                <div class="col-md-2">
                                    <label for="speed" style="text-align:left"><b>Typing Certificate:</b></label>
                                </div>
                                <div class="col-md-4">
                                    <?php
                                    if ($typing_certi != '') {
                                    ...
                                    ?>
                                    <input type="file" name="typing_certi" id="typing_certi"></input>
                                    <a href="<?php echo $typing_certi; ?>" id="typing_certi_view" style="<?php echo $style_typing_certi; ?>" target="_blank"><b><u>View</u></b></a>
                                    <input type="hidden" id="typing_certi1" name="typing_certi1" value="<?php echo isset($valt) ? "$valt" : ""; ?>" />
                                </div>
                                <div id="typing_type" style="display:<?php
                                                                        if (isset($typing_language) && $typing_language == "Hindi") {
                                                                            echo 'block';
                                                                        } else {
                                                                            echo 'none';
                                                                        }
                                    ...
                                    <div class="col-md-2">
                                        <label for="sspeed" style="text-align:left"><b>Typing Type:</b></label>
                                    </div>
                                    <div class="col-md-4">
                                        <select name="typing_language" id="typing_language" class="form-control">
                            ...
                            <div id="inf_emp_div" style="display: <?php
                                                                    ...
                                                                    ?>">
                                <div class="col-md-2">
                                    <label for="payroll" style="text-align:left"><b>Enter Payroll Number:</b></label>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div style="padding-bottom: 10px">
                        <center>
                            <?php if ($_SESSION['is_login'] == 'true') { ?>
                                <a href='#' class="btn btn-primary" pull-rightid="a1" data-toggle="tab" onclick="return a1();" role="button" class="btn btn-primary">Save & Next</a>
                            <?php } else { ?>
                                <input type="submit" id="save_temp" name="save_temp" class="btn btn-primary " onclick="return save1();" value="Save"></input> <?php } ?>
                        </center>
                    </div>
                </form>
            </div>
            <div id="educational" class="tab-pane fade" style="border: 1px gray outset;border-radius: 5px;">
                <form id="educationalform" action="update2.php" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="left">2.<font style='color:red'><?php echo ($post != 'STOICS-1-2022') ? '*' : ''; ?></font>
                                </td>
                                <td>
                                    <select class="form-control" name="edu2" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?>>
                                    ...
                                    <!--<input name="edu2" class="form-control" value="HSC" readonly="readonly"  maxlength="45"  size="30" type="text"  /></td>-->
                                <td>
                                    <select name="speci2" id="speci2" class="form-control" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?>>
                                    ...
                                    </select> <!--<input name="speci2" class="form-control"  maxlength="75"  size="30" type="text" value="NA" readonly/>-->
                                </td>
                                <td><input name="board2" class="form-control" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?> maxlength="200" size="30" type="text" value="<?php echo isset($board2) ? "$board2" : ''; ?>" /></td>
                                <td width="20%"><input name="year2" id="year2" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?> class="form-control" maxlength="20" type="text" size="20" value="<?php echo isset($year2) ? "$year2" : ''; ?>" /></td>
                                <td><input name="per2" class="form-control" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?> maxlength="6" size="10" type="text" min="0" max="100" placeholder="00.00" value="<?php echo isset($per2) ? "$per2" : ''; ?>" /></td>
                                <td>
                                    <select class="form-control" name="div2" <?php echo ($post != 'STOICS-1-2022') ? 'required' : ''; ?>>
                                        <option value="">Select Option</option>
                                ...
                                <td>
                                    <input type="file" name="hsc_certi" id="hsc_certi" style="display:inline-block" <?php
                                                                                                                    if ($hsc_certi == "" && $post != "STOICS-1-2022") {
                                                                                                                        echo "required";
                                                                                                                    }
                                                                                                                    ?>></input>
                                </td>
                            ...
                            <?php if ($post == "STOICS-1-2022") { ?>
                                <tr>
                                    <td align="left">2.1 <font style='color:red'><?php echo ($post == 'STOICS-1-2022') ? '*' : ''; ?></font>
                                    </td>
                                    <td><input name="edu7" class="form-control" value="DCA/Equivalent" readonly="readonly" maxlength="45" size="30" type="text" /></td>
                                    <td><input type="text" name="speci7" id="speci7" class="form-control" value="<?php echo isset($speci7) ? "$speci7" : ''; ?>" required></input></td> <!--<input name="speci2" class="form-control"  maxlength="75"  size="30" type="text" value="NA" readonly/>--></td>
                            ...
                            <tr>
                                ...
                                <td><input name="year3" id="year3" class="form-control" <?php
                                                                                        ...
                                                                                        ?> maxlength="20" type="text" size="20" value="<?php echo isset($year3) ? "$year3" : ''; ?>" /></td>
                            ...
                            <tr>
                                ...
                                <td><input name="year4" id="year4" class="form-control" <?php
                                                                                        ...
                                                                                        ?> maxlength="20" type="text" size="20" value="<?php echo isset($year4) ? "$year4" : ''; ?>" /></td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href='#' id="prev1" data-toggle="tab" onclick="return prev_to1();" role="button" class="btn btn-primary">
                                        << Previous</a>
                                </td>
                                <td></td>
                                <td></td>
                                ...
                                <td colspan="2">
                                    <div class=" btn-toolbar">
                                        <a href="#" id="a2" data-toggle="tab" onclick="return a2();" role="button" class="btn btn-primary pull-right">Save & Next</a>
                                    </div>
                                </td>
                                <td></td>
                            </tr>
            ...
            <div id="experience" class="tab-pane fade" style="border: 1px gray outset;border-radius: 5px;">
                <form id="expform" action="update3.php" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-hover" id="expr_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="7">
                                    <a href='#' id="prev2" data-toggle="tab" onclick="return prev_to2();" role="button" class="btn btn-primary">
                                        << Previous</a>
                                ...
                                <td colspan="3">
                                    <div class=" btn-toolbar">
                                        <a href="#" id="a3" data-toggle="tab" onclick="return a3();" role="button" class="btn btn-primary pull-right">Save & Next</a>
                                        <?php if ($_SESSION['is_login'] == 'true') { ?> <!--<input type="button" id="update3" name="update3" class="btn btn-primary pull-right"  onclick="return update_3();" value="save"/>--><?php } ?>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div id="upload_docs" class="tab-pane fade" style="border: 1px gray outset;border-radius: 5px;">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" class="text-center">
                                    <a href="https://www.onlinesbi.com/sbicollect/icollecthome.htm?corpID=1734565" target="_blank" class="btn btn-warning" onclick="return confirm('FEES FOR SC, ST, PwBD (more than 40% permanent disability) Rs. 500  AND  FEES FOR ALL OTHERS INCLUDING UNRESERVED(GENERAL), OBC, EX.SERVICEMAN ETC. RS. 1000')">Click here to pay fees online</a>
                                    <div class="bg-info" style="padding: 10px 20px; margin-top: 8px;">

                                        <strong>
                                            <p class="blinking">FEES FOR SC, ST, PwBD (more than 40% permanent disability) Rs. 500</p>
                                            <p class="blinking">FEES FOR ALL OTHERS INCLUDING UNRESERVED(GENERAL), OBC, EX.SERVICEMAN ETC. RS. 1000</p>
                                        </strong>
                            ...
                            <tr id="dd_div">
                                <td align="center">1.<font style="color:red">*</font>
                                </td>
                                <td colspan="2">
                                    <?php
                                    ...
                                    ?>
                                    Transaction Number <span style="color:red">(Please enter unique number only. For Example: DUC1234567) </span><br />
                                    <input type="text" name="transaction_pref" id="transaction_pref" maxlength="3" placeholder="DUC/DUE" required class="form-control" value="<?php
                                                                                                                                                                                if ($transaction_ref_no_pref != "" && transaction_ref_no != "") {
                                                                                                                                                                                    echo $transaction_ref_no_pref;
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo "DUC";
                                                                                                                                                                                }
                                                                                                                                                                                ?>"></input>
                                    <input type="text" name="transaction_ref_no" maxlength="10" id="transaction_ref_no" placeholder="Transaction number only" required value="<?php echo isset($transaction_ref_no) ? "$transaction_ref_no_new" : ""; ?>" class="form-control" <?php
                                ...
                                <td>
                                    ...
                                    <input type="text" name="dd_date" placeholder="Transaction Date" id="dd_date" readonly required value="<?php echo isset($dd_date) ? "$dd_date" : ""; ?>" class="form-control" <?php
                                                                                                                                                                                                                    if ($dd_date != "") {
                                                                                                                                                                                                                        echo "readonly";
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                    ?>></input>
                            ...
                            <tr id="dd_div1">
                                ...
                                <td>
                                    Transaction Amount
                                    <select name="dd_amount" id="dd_amount" class="form-control" required>
                                        <option value="">Select Transaction Amount</option>
                                        <?php if ($caste == "SC" || $caste == "ST" || ($disability == "Yes" && $disability_percentage >= 40)) { ?>
                                    ...
                                    <!--<input type="number" name="dd_amount" id="dd_amount" minlength="3" maxlength="4" required value="<?php // echo isset($dd_amount) ? "$dd_amount" : "";                                   
                                                                                                                                            ?>" class="form-control" />-->
                                </td>
                                <td colspan="2">
                                    <?php
                                    if ($fees_receipt != '') {
                                        $stylef = "visibility: visible;";
                                    } else {
                                        $stylef = "visibility: hidden;";
                                    }
                                    ?>
                                    Copy of the Fee Receipt (SBI Collect)
                                    <input type="file" name="file_fees" id="file_fees" class="form-control" <?php
                                                                                                            if ($fees_receipt == "") {
                                                                                                                echo "required";
                                                                                                            }
                                                                                                            ?>></input>
                                ...
                                <!--<td>
                                        Bank Name
                                        <input type="text" name="bank_name" id="bank_name" value="<?php echo isset($bank_name) ? "$bank_name" : ""; ?>"  class="form-control"></input>
                                    </td>
                                    <td>
                                        Bank Branch Name
                                        <input type="text" name="branch_name" id="branch_name" value="<?php echo isset($branch_name) ? "$branch_name" : ""; ?>" class="form-control"></input>
                                    </td>-->
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    Passport Size Photo (JPG/PNG) (Max 50 KB size) :
                                </td>
                                <td>
                                    <?php
                                    if ($photo != '') {
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    Current Sign (JPG/PNG) (Max 50 KB size) :
                                </td>
                                <td>
                                    <?php
                                    if ($sign != '') {
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    Date of Birth Proof (Pancard/Aadharcard/Leaving Certi./SSC Certi.) (JPG/PNG) (Max 50 KB size) :
                                </td>
                                <td>
                                    <?php
                                    if ($dob_proof != '') {
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    NOC from current organization (if applicable)(JPG/PNG/PDF) (Max 200 KB size) :
                                </td>
                                <td>
                                    <?php
                                    if ($noc != '') {
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    Other relevant document[s](if applicable)(JPG/PNG/PDF) (Max 200 KB size) :
                                </td>
                                <?php
                                if ($otherdoc != '') {
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <div class=" btn-toolbar">
                                        <a href='#' id="prev3" data-toggle="tab" onclick="return prev_to3();" role="button" class="btn btn-primary">
                                            << Previous</a>
                                                <a href="#" id="a4" data-toggle="tab" onclick="return a4();" target="_blank" role="button" class="btn btn-primary pull-right">Save & Next</a>
            ...
            <div id="others" class="tab-pane fade" style="border: 1px gray solid; border-radius: 5px;">
                <form id="otherform" action="update5.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <center>
                                <a href='#' id="prev4" data-toggle="tab" onclick="return prev_to4();" role="button" class="btn btn-primary">
                                    << Previous</a>
                                        <?php if ($_SESSION['is_login'] == 'true') { ?>
                                            <input type="button" name="Submit_btn" id="submit_btn" onclick="submit_form();" class="btn btn-primary" value="Submit" />
                                        <?php } ?>
                                        <input type="button" id="update5" name="update5" class="btn btn-primary" style="width:10%;background-color: #337ab7;color:white" onclick="return update_5();" value="Save" />
    ...
    <div id="dialog" style="display: none;" align="center">
        ...
        <strong style="color:red">The hardcopy of the online Application along with legible/readable copies of all self-attested testimonials, certificates and all supporting documents to "Recruitment Cell, INFLIBNET Centre, OPP.NIFT, Infocity, Gandhinagar, Gujarat-382007" on or before 02/05/2022 upto 05.30 pm, failing which the application will be rejected. <br />Application not made online and print out of online Application along with all testimonials not received will be summarily rejected.</strong>
        </br></br>
...
<script type="text/javascript">
    ...
    function validate1() {
        ...
        if (document.frmregister.mobile.value.length != 10) {
            ...
            if (document.frmregister.disability_percentage.value == "") {
                ...
                return false;
            } else if (document.frmregister.disability_percentage.length >= 3) {
                alert("Percentage of Disability valid only two digit.");
                document.frmregister.disability_percentage.focus();
                return false;
            }
            //                                else if (document.frmregister.disability_percentage.value < 40) {
            //                                    alert("Percentage of Disability must be 40% or more.");
            //                                    document.frmregister.disability_percentage.focus();
            //                                    return false;
            //                                } 
        ...
        } else if (document.frmregister.post.value == "CCTAdmin-1-2020") {
            if (document.frmregister.typing_speed.value == "") {
                ...
                alert("Minimum 35 Typing Speed Required.");
                ...
                alert("Minimum 30 Typing Speed Required.");
                document.getElementById("typing_speed").value = "";
                document.frmregister.typing_speed.focus();
                return false;
            } else {
        ...
        } else if (document.frmregister.post.value == "PSAdmin-1-2022") {
            if (document.frmregister.stenoGraphy_speed.value == "") {
                ...
                document.frmregister.typing_certi.focus();
                return false;
            } else if (document.frmregister.type_of_service.value == "") {
    ...
    function validate2() {
        //    var_ssc_certi = $("#ssc_certi_view").css("visibility");
        //    var_hsc_certi = $("#hsc_certi_view").css("visibility");
        //    var_bachelor_certi = $("#bachelor_certi_view").css("visibility");
        //    var_master_certi = $("#master_certi_view").css("visibility");
        //    var_phd_certi = $("#phd_certi_view").css("visibility");
    ...
    $('#file_fees').change(function() {
        ...
        if (Math.round(document.getElementById("file_fees").files[0].size / 1024) > 200) {
    ...
    $('#disability_certi').change(function() {
        ...
        if (Math.round(document.getElementById("disability_certi").files[0].size / 1024) > 200) {
            alert("Disability Certificate should be less than 200 KB.");
            document.getElementById("disability_certi").value = null;
        }
    });
    ...
    $('#stenography_certi').change(function() {
        ...
        if (Math.round(document.getElementById("stenography_certi").files[0].size / 1024) > 200) {
            alert("Stenography Certificate should be less than 200 KB.");
            document.getElementById("stenography_certi").value = null;
        }
    });
    ...
    $('#typing_certi').change(function() {
        ...
        if (Math.round(document.getElementById("typing_certi").files[0].size / 1024) > 200) {
            alert("Typing Certificate should be less than 200 KB.");
            document.getElementById("typing_certi").value = null;
        }
    });
    ...
    $('#file_1').change(function() {
        ...
        if (Math.round(document.getElementById("file_1").files[0].size / 1024) > 200) {
            alert("Photo should be less than 200 KB.");
            document.getElementById("file_1").value = null;
        }
    });
    $('#file_2').change(function() {
        ...
        if (Math.round(document.getElementById("file_2").files[0].size / 1024) > 200) {
            alert("Signature file size should be less than 200 KB.");
            document.getElementById("file_2").value = null;
        }
    });
    $('#file_5').change(function() {
        ...
        if (Math.round(document.getElementById("file_5").files[0].size / 1024) > 200) {
            alert("DOB Proof file size should be less than 200 KB.");
            document.getElementById("file_5").value = null;
        }
    });
    $('#file_3').change(function() {
        ...
        if (Math.round(document.getElementById("file_3").files[0].size / 1024) > 200) {
            alert("NOC Document size should be less than 200 KB.");
            document.getElementById("file_3").value = null;
        }
    });
    $('#file_4').change(function() {
        ...
        if (Math.round(document.getElementById("file_4").files[0].size / 1024) > 200) {
            alert("Other Document size should be less than 200 KB.");
            document.getElementById("file_4").value = null;
        }
    });
    $('#caste_certi').change(function() {
        ...
        if (Math.round(document.getElementById('caste_certi').files[0].size / 1024) > 200) {
            alert("Caste Certificate should be less than 200 KB.");
            document.getElementById("caste_certi").value = null;
        }
    });
    ...
    $('#ssc_certi').change(function() {
        ...
        if (Math.round(document.getElementById('ssc_certi').files[0].size / 1024) > 200) {
            alert("SSC Certificate should be less than 200 KB.");
            document.getElementById("ssc_certi").value = null;
        }
    });
    ...
    $('#hsc_certi').change(function() {
        ...
        if (Math.round(document.getElementById('hsc_certi').files[0].size / 1024) > 200) {
            alert("HSC Certificate should be less than 200 KB.");
            document.getElementById("hsc_certi").value = null;
        }
    });
    ...
    $('#bachelor_certi').change(function() {
        ...
        if (Math.round(document.getElementById('bachelor_certi').files[0].size / 1024) > 200) {
            alert("Bachelor Degree Certificate should be less than 200 KB.");
            document.getElementById("bachelor_certi").value = null;
        }
    });
    $('#master_certi').change(function() {
        ...
        if (Math.round(document.getElementById('master_certi').files[0].size / 1024) > 200) {
            alert("Master Degree Certificate should be less than 200 KB.");
            document.getElementById("master_certi").value = null;
        }
    });
    $('#phd_certi').change(function() {
        ...
        if (Math.round(document.getElementById('phd_certi').files[0].size / 1024) > 200) {
            alert("PHD/Other Certificate should be less than 200 KB.");
            document.getElementById("phd_certi").value = null;
        }
    });
    ...
    $('#other_edu_certi').change(function() {
        ...
        if (Math.round(document.getElementById('other_edu_certi').files[0].size / 1024) > 200) {
            alert("DCA Certificate should be less than 200 KB.");
            document.getElementById("other_edu_certi").value = null;
        }
    });
    ...
    $('#exp_file1').change(function() {
        ...
        if (Math.round(document.getElementById('exp_file1').files[0].size / 1024) > 200) {
            alert("Experience Certificate should be less than 200 KB.");
            document.getElementById("exp_file1").value = null;
        }
    });
    ...
    $('#exp_file2').change(function() {
        ...
        if (Math.round(document.getElementById('exp_file2').files[0].size / 1024) > 200) {
            alert("Experience Certificate should be less than 200 KB.");
            document.getElementById("exp_file2").value = null;
        }
    });
    ...
    $('#exp_file3').change(function() {
        ...
        if (Math.round(document.getElementById('exp_file3').files[0].size / 1024) > 200) {
            alert("Experience Certificate should be less than 200 KB.");
            document.getElementById("exp_file3").value = null;
        }
    });
    ...
    $('#exp_file4').change(function() {
        ...
        if (Math.round(document.getElementById('exp_file4').files[0].size / 1024) > 200) {
            alert("Experience Certificate should be less than 200 KB.");
            document.getElementById("exp_file4").value = null;
        }
    });
    ...
    $('#exp_file5').change(function() {
        ...
        if (Math.round(document.getElementById('exp_file5').files[0].size / 1024) > 200) {
            alert("Experience Certificate should be less than 200 KB.");
            document.getElementById("exp_file5").value = null;
        }
    });
    ...
    function categoryByPost() {
        ...
        if (post != '' && (post == 'PSAdmin-1-2022' || post == 'AAdmin-1-2022')) {
