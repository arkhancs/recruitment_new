        ...
        <div style="border:1px solid #eeeeee;" class="p10">
            ...
            <ol start="1" class="text_style p20">
                ...
                <?php } else if ($post == 'PSAdmin-2-2023') { ?>
                    <li> <strong>Candidates must bring any of their original Photo Identity Card & Admit Card failing which candidates will not be allowed to appear for the test/interview.</strong> </li>
                ...
                <?php } else if ($post == 'SAOAAdmin-2-2025') { ?>
                    <li>
                        <strong>
                            Candidates must bring any of their original Photo Identity Card & Admit Card failing which
                            candidates will not be allowed to appear for the written test.
                        </strong>

                    </li>
                <?php } else { ?>

                    <!-- <li> <strong>Candidates must bring any of their original Photo Identity Card & Admit Card failing which candidates will not be allowed to appear for the written test.</strong></li> -->
                    <li> <strong>Candidates must bring any of their original Photo Identity Card & Admit Card failing which candidates will not be allowed to appear for the interview.</strong></li>
                <?php } ?>

                <?php if ($post == 'SBLS-2-2025') { ?>
                    <li> <strong> Candidates will be permitted to carry ONLY Admit Card, Photo Identity Proof, Black Ball Pen and a Writing Pad . NOTHING ELSE will be allowed inside the examination hall.</strong></li>
                ...
                <?php } else if ($post == 'MTSAdmin-1-2025') { ?>
                    <li>The date of written test is liable to change, if circumstances so warrant.</li>
                    <li><b>Candidates are required to carry all original testimonials in respect of Date of Birth proof, Academic (marksheets of qualifying exam and degree certificates), Experience certificates and <u>NOC</u> etc. mentioned in their application, failing which candidates will not be permitted to appear in written test.</b></li>
                ...
                <?php } else if ($post == 'SAOAAdmin-2-2025') { ?>
                    ...
                    <li>
                        <b>
                            Candidates are required to carry all original testimonials in respect of Date of Birth proof,
                            Academic (marksheets of qualifying exam and degree certificates), Experience certificates,
                            latest OBC Certificate (issued on or after 01.04.2025) of GOI and
                            <u>NOC</u> etc. mentioned in their application, failing which candidates will not be permitted
                            to appear in written test.
                        </b>
                    </li>
                <?php } else if ($post == 'AAdmin-2-2025') { ?>
                    <li>The date of written test is liable to change, if circumstances so warrant.</li>
                    <li>
                        <b>
                            Candidates are required to carry all original testimonials in respect of Date of Birth proof,
                            Academic (marksheets of qualifying exam and degree certificates), Experience certificates and
                            <u>NOC</u> etc. mentioned in their application, failing which candidates will not be permitted
                            to appear in written test.
                        </b>
                    </li>
                ...
                <?php } else { ?>
                    ...
                    <li>
                        <b>
                            Candidates are required to carry all original testimonials in respect of Date of Birth proof,
                            <?php if ($post == 'SDCS-2-2025') { ?>
                                OBC(NCL) Caste Certificate of current validity,
                            <?php } ?>
                            Academic (marksheets of qualifying exam and degree certificates), Experience certificates and
                            <u>NOC</u> etc. mentioned in their application, failing which candidates will not be permitted to appear in interview.
                        </b>
                    </li>
                    <!-- <li>Provisionally eligible candidates are required to submit their missing/required documents/certificate shown against their application id in the list uploaded on the website of the Centre, on or before <strong>08.09.2025 upto 06.00 pm</strong> through email only at <strong>recruitment@inflibnet.ac.in</strong> failing which candidate will not be permitted to appear in the Interview, It will be entirely at their risk and cost.</li> -->
                <?php } ?>
