    ...
    <div class="login-form white-text">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                <!-- NEW: Change Password link added inline -->
...
<li><i class="fa fa-hand-o-right"></i> Documents Verified 
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="col-md-12 col-sm-12 col-xs-12 buttonGroup">
                        ...
                        <?php
                        // echo "<pre>";
                        // echo "========== DEBUG first IF condition ==========\n";
                        // echo "\$status               : " . var_export($status, true) . "\n";
                        // echo "\$status_check         : " . var_export($status_check, true) . "\n";
                        // echo "\$exam_date            : " . var_export($exam_date, true) . "\n";
                        // echo "\$post                 : " . var_export($post, true) . "\n";
                        // echo "\$year                 : " . var_export($year, true) . "\n";

                        // echo "\n--- Step-by-step evaluation ---\n";

                        // echo "1) (\$status == 'current')                             : " . var_export(($status == 'current'), true) . "\n";
                        // echo "2) (\$status_check == 'Eligible')                      : " . var_export(($status_check == 'Eligible'), true) . "\n";
                        // echo "3) (\$status_check != 'Provisionally')                 : " . var_export(($status_check != 'Provisionally'), true) . "\n";
                        // echo "   (2 || 3)                                           : " . var_export(($status_check == 'Eligible' || $status_check != 'Provisionally'), true) . "\n";
                        // echo "4) (\$exam_date != '')                                 : " . var_export(($exam_date != ''), true) . "\n";
                        // echo "5) (\$post == 'MTSAdmin-1-2025')                       : " . var_export(($post == 'MTSAdmin-1-2025'), true) . "\n";
                        // echo "6) (\$year == '2025')                                  : " . var_export(($year == '2025'), true) . "\n";

                        // echo "\n--- Final condition ---\n";
                        // $final = (
                        //     $status == 'current'
                        //     && ($status_check == 'Eligible' || $status_check != 'Provisionally')
                        //     && $exam_date != ''
                        //     && $post == 'MTSAdmin-1-2025'
                        //     && $year == '2025'
                        // );
                        // echo "Entire condition evaluates to : " . var_export($final, true) . "\n";
                        // echo "</pre>";
                        ?>
                        ...
                        ?>
                            <?php
                            // if ($status == 'current' && ($status_check == 'Eligible') && $exam_date != '' && ($post == 'SDCS-2-2025') && $year == '2025') {
                            ?>

                            <?php
                            if (
                                ($post == 'SELS-2-2025' && $current_date <= "2026-02-17 09:00:00") ||
                                ($post == 'SDCS-2-2025' && $current_date <= "2026-02-13 09:00:00") ||
                                ($post == 'SBLS-2-2025' &&
                                    $current_date >= "2026-02-01 09:00:00" &&
                                    $current_date <= "2026-02-17 09:00:00")
                            ) {
                            ?>
                            ...
                            <a href="print_application.php" class="borderWhite login-btn btn btn-block blueBtn print_application">
                                <i class="fa fa-print f30"></i> <br>Print Application
                            </a>
                        ...
                        ?>
                            <a href="javascript:void(0)" class="borderWhite login-btn btn btn-block blueBtn application_form"><i class="fa fa-address-card-o f30"></i> <br>Complete Application</a>
