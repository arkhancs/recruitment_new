                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="service_div" style="display:<?php
                                                                if (isset($post) && ($post == 'AOAdmin-1-2023' || $post == 'AOFAdmin-1-2023' || $post == 'PSAdmin-1-2023' || $post == 'CCTAdmin-1-2023')) {
                                                                    echo "block";
                                                                } else {
                                                                    echo "none";
                                                                }
                        ...
                        <div id="typing_div" style="display:<?php
                                                            if (isset($post) && ($post == "PSAdmin-1-2023")) {
                                                                echo 'block';
                                                            } else {
                                                                echo 'none';
                                                            }
                        ...
                        <div id="typing_div1" style="display:<?php
                                                                if (isset($post) && ($post == "CCTAdmin-1-2023")) {
                                                                    echo 'block';
                                                                } else {
                                                                    echo 'none';
                                                                }
            ...
            <form id="educationalform" action="update2.php" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="left">2.<font style='color:red'><?php echo ($post != 'STACS-1-2023') ? '*' : ''; ?></font>
                            </td>
                            <td>
                                <select class="form-control" name="edu2" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?>>
                            ...
                            <td>
                                <select name="speci2" id="speci2" class="form-control" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?>>
                            ...
                            <td><input name="board2" class="form-control" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?> maxlength="200" size="30" type="text" value="<?php echo isset($board2) ? "$board2" : ''; ?>" /></td>
                            <td width="20%"><input name="year2" id="year2" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?> class="form-control" maxlength="20" type="text" size="20" value="<?php echo isset($year2) ? "$year2" : ''; ?>" onchange="check_hsc_date()" /></td>
                            <td><input name="per2" class="form-control" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?> maxlength="6" size="10" type="text" min="0" max="100" placeholder="00.00" value="<?php echo isset($per2) ? "$per2" : ''; ?>" /></td>
                            <td>
                                <select class="form-control" name="div2" <?php echo ($post != 'STACS-1-2023') ? 'required' : ''; ?>>
                                    <option value="">Select Option</option>
                            ...
                            <td>
                                <input type="file" name="hsc_certi" id="hsc_certi" style="display:inline-block" <?php
                                                                                                                if ($hsc_certi == "" && $post != "STACS-1-2023") {
                                                                                                                    echo "required";
                                                                                                                }
                                                                                                                ?>></input>
                            </td>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" class="text-center">
                                <a href="https://www.onlinesbi.com/sbicollect/icollecthome.htm?corpID=1734565" target="_blank" class="btn btn-success" onclick="return confirm('FEES FOR SC, ST, PwBD (more than 40% permanent disability) Rs. 500  AND  FEES FOR ALL OTHERS INCLUDING UNRESERVED(GENERAL), OBC, EX.SERVICEMAN ETC. RS. 1000')">Click here to pay fees online</a>
                        ...
                        <tr id="dd_div">
                            ...
                            <td colspan="2">
                                ...
                                ?>
                                Transaction Number <span style="color:red">(Please enter unique number only. For Example: DUK1234567) </span><br />
                                <input type="text" name="transaction_pref" id="transaction_pref" maxlength="3" placeholder="DUC/DUK" required class="form-control" value="<?php
                                                                                                                                                                            ...
                                                                                                                                                                            ?>"></input>
                                <input type="text" name="transaction_ref_no" maxlength="10" id="transaction_ref_no" placeholder="Transaction number only Example, 123456" required value="<?php echo isset($transaction_ref_no) ? "$transaction_ref_no_new" : ""; ?>" class="form-control" <?php
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                Passport Size Photo (JPG/PNG) (Max 200 KB size) :
                            </td>
                            <td>
                                <?php
                                if ($photo != '') {
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                Current Sign (JPG/PNG) (Max 200 KB size) :
                            </td>
                            <td>
                                <?php
                                if ($sign != '') {
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                Date of Birth Proof (Pancard/Aadharcard/Leaving Certi./SSC Certi.) (JPG/PNG) (Max 200 KB size) :
                            </td>
                            <td>
                                <?php
                                if ($dob_proof != '') {
...
<div id="dialog" style="display: none;" align="center">
    ...
    <strong style="color:red">The hardcopy of the online Application along with legible/readable copies of all self-attested testimonials, certificates and all supporting documents to "Recruitment Cell, INFLIBNET Centre, OPP.NIFT, Infocity, Gandhinagar, Gujarat-382007" on or before 05/03/2023 upto 05.30 PM, failing which the application will be rejected. <br />Application not made online and print out of online Application along with all testimonials not received will be summarily rejected.</strong>
    </br></br>
...
<script type="text/javascript">
    ...
    function validate1() {
        ...
        } else if (document.frmregister.post.value == "CCTAdmin-1-2023") {
        ...
        } else if (document.frmregister.post.value == "PSAdmin-1-2023") {
