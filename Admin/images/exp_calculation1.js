...
//months=0;
    ...
    $("#to2").datepicker({
        ...
        //     $(this).val('');
          ...
          //  months=0;
            calculate(from1, to1, from2, to2, from3, to3, from4, to4, from5, to5);
            //  $('#total_exp').html((parseInt(parseInt(temp_array1[0]) + parseInt(temp_array2[0]) + parseInt(temp_array3[0]) + parseInt(temp_array4[0]) + parseInt(temp_array5[0])) + '.' + parseInt(parseInt(temp_array1[1]) + parseInt(temp_array2[1]) + parseInt(temp_array3[1]) + parseInt(temp_array4[1]) + parseInt(temp_array5[1])) + '.' + parseInt(parseInt(temp_array1[2]) + parseInt(temp_array2[2]) + parseInt(temp_array3[2]) + parseInt(temp_array4[2]) + parseInt(temp_array5[2])))).closest('tr').show();
        }
    });
    /***************************************************************** For 3 *********************/
    $("#from3").datepicker({
   ...
   // months=0;
    ...
    $("#to3").datepicker({
        ...
        changeMonth: true,
        changeYear: true,
   dateFormat: "mm/dd/yy",        yearRange: '-50:+0',
        onClose: function (selectedDate) {
