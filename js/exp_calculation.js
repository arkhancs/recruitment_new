...
function CalculateTotalExp_old() {
    var TotalExp = [];
...
function CalculateTotalExp() {
    ...
    var yAppendix = Year  > 1 ? " years" : " year";
    var mAppendix = Month > 1 ? " months" : " month";
    var dAppendix = Day   > 1 ? " days"   : " day";

    var display = Year + yAppendix + ", " + Month + mAppendix + ", and " + Day + dAppendix;
    $("#exp_count").val(display);
    $("#total_exp").text(display);
}

function getExp_old(date_1, date_2) {
