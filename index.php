  ...
  <div class="login-form">
    <form name="form1" method="post">
      <div class="row titleText">
        ...
        <?php if ($current_date1 <= "2026-02-13 09:00:00") { ?>
          <!-- <div class="col-xs-12">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 text-center">
                <div class="buttonGroup">
                  <a href="login.php"
                    class="borderWhite login-btn btn blueBtn"
                    style="display:inline-block; max-width:300px; width:100%; margin:0 auto;">
                    <i class="fa fa-address-card-o f30"></i><br>Download Admit Card
                  </a>
                  ...
                  <ul class="contactBox">
                    ...
                    <li style="color:white !important">
                      ...
                      Advt. No. 02/2025: Scientist-D (Computer Science)

                    </li>
                    <li style="color:white !important">
                      <i class="fa fa-hand-o-right"></i>
                      Advt. No. 02/2025: Senior Assistant / Office Assistant-II
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3 text-center">
              <div class="buttonGroup">
                ...
                <?php if ($current_date1 <= "2026-02-17 09:00:00") { ?>
                  <a href="login.php"
                    class="borderWhite login-btn btn blueBtn"
                    style="display:inline-block; max-width:300px; width:100%; margin:0 auto;">
                    <i class="fa fa-address-card-o f30"></i><br>Download Admit Card
                ...
                <ul class="contactBox">
                  <?php if ($current_date1 <= "2026-02-17 09:00:00") { ?>
                    <li style="color:white !important">
                      <i class="fa fa-hand-o-right"></i>
                      Advt. No. 02/2025: Scientist-E (Library Science)
                    </li>
                  <?php } ?>
                  ...
                  <?php if (
                    $current_date1 >= "2026-02-01 09:00:00" &&
                    $current_date1 <= "2026-02-17 09:00:00"
                  ) { ?>
                    <li style="color:white !important">
                      <i class="fa fa-hand-o-right"></i>
                      Advt. No. 02/2025: Scientist-B (Library Science)
                    </li>
                  <?php } ?>
