...
if (isset($_POST['Submit'])) {
  ...
  if (mysqli_num_rows($result_check) == 0) {
    ...
    if (($db_age['category'] == "Admin" || $db_age['category'] == "Finance") && $inf_employee == "No") {
      if ($post == "AOAdmin-1-2023" || $post == "AOFAdmin-1-2023" || $post == "PSAdmin-2-2023" || $post == "TestCCTAdmin-2-2025" || $post == "MTSAdmin-1-2025") {
      ...
      } else if ($post == "SAOAAdmin-2-2025" && ($caste == "OBC" || $caste == "OBCEx")) {
        // var_dump($post, $caste, $agenew);
        // exit();
        // } else if ($post == "SAOAAdmin-2-2025" && $caste == "OBC") {
        if ($disability == "Yes" && $disability_percentage >= 40 && $caste != "Ex-servicemen" && $type_of_job == "Permanent" && $caste != "OBCEx") {
          $db_age_new = $db_age['age_limit'] + 18;
        } else if ($disability == "Yes" && $disability_percentage >= 40 && $caste != "Ex-servicemen" && $type_of_job != "Permanent" && $caste != "OBCEx") {
        ...
        } else if ($disability == "No" && $caste != "Ex-servicemen" && $type_of_job != "Permanent" && $caste != "OBCEx") {
        ...
        } else if ($disability == "No" && $caste == "OBCEx" && $type_of_job != "Permanent") {
          $db_age_new = $db_age['age_limit'] + $length_of_service_new + 6;
        } else if ($disability == "No" && $caste == "OBCEx" && $type_of_job == "Permanent") {
          $db_age_new = $db_age['age_limit'] + $length_of_service_new + 6 + 5;
        } else {
          $db_age_new = $db_age['age_limit'] + 3;
        }
      } else {
      ...
      if ($post == "SDCS-2-2025" && ($caste == "OBC" || $caste == "OBCEx")) {
        if ($disability == "Yes" && $disability_percentage >= 40 && $caste != "Ex-servicemen" && $caste != "OBCEx") {
          $db_age_new = $db_age['age_limit'] + 13;
        } else if ($disability == "Yes" && $disability_percentage >= 40 && $caste == "Ex-servicemen" && $caste != "OBCEx") {
          $db_age_new = $db_age['age_limit'] + $length_of_service_new + 16;
        } else if ($disability == "No" && $caste != "Ex-servicemen" && $caste != "OBCEx") {
          $db_age_new = $db_age['age_limit'] + 3;
        } else if ($disability == "No" && ($caste == "Ex-servicemen" || $caste == "OBCEx")) {
          $db_age_new = $db_age['age_limit'] + $length_of_service_new + 6;
        } else {
        ...
        if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            try {
              ...
              $_SESSION['forget_msg'] = '<div class="text-center alert alert-danger">Error: ' . $e->getMessage() . '</div>';
              header("Location:forget_password.php");
              exit; // Added exit
            }
          }
